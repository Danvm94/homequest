...
- [Automated Testing](#automated-testing)
    - [Unit Testing](#unit-testing)
        - [checkout/tests](#checkouttests)
        - [homepage/tests](#homepagetests)
        - [profiles/tests](#profilestests)
    - [Site Coverage Report](#site-coverage-report)
- [Manual Testing](#manual-testing)
    - [User Story Testing](#user-story-testing)
        - [Homepage](#homepage)
        - [AllAuth Implementation](#allauth-implementation)
        - [Bootstrap Toast Django Implementation](#bootstrap-toast-django-implementation)
        - [NavBar](#navbar)
        - [Footer](#footer)
        - [Properties](#properties)
        - [Edit and Create Property](#edit-and-create-property)
    ...
    - [Javascript Testing](#javascript-testing)
        ...
        - [Bootstrap Toasts](#bootstrap-toasts)
        - [Stripe](#stripe)
...
- [Bugs & Fixes](#bugs--fixes)
    - [W3C Markup Validator](#w3c-markup-validator-1)
        - [Refactor: Resolve HTML validation issues in login and register forms](#refactor-resolve-html-validation-issues-in-login-and-register-forms)
        - [Refactor: Resolve HTML validation issues in the Buy page](#refactor-resolve-html-validation-issues-in-the-buy-page)
        - [Refactor: Address small HTML validation issues](#refactor-address-small-html-validation-issues)
